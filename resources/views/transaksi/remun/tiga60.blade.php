                ...
                <div class="box-header with-border">
                    ...
                    @if(isset(Auth::user()->unit) == 999) 
                        <a href="{{ url('/remun/tiga60/gendef') }}" title="Back"><button class="btn btn-success btn-sm">
                         Generate</button></a>
                         <a href="{{ url('/grading') }}" title="Back"><button class="btn btn-success btn-sm">
                         Grade</button></a>
                    @endif
                                        ...
                                        <tr>
                                            ...
                                            @if (Auth::user()->atas == 2)
                                                ...
                                                <center class="form-group">
                                                    <input class="iradio_flat-green" style="text-align: right"
                                                        ...
                                                        placeholder="60" min="60" max="95" name="{{ $kol }}[{{ $key }}][{{ $k }}]"
                                                        type="range" value="{{ $i+1 }}" @if(($isi[$rekan[$kol]->id][$key][$k] ?? 2) == $i+1) checked @endif
                                                        required>
                                                    <output>60</output>
                                                </center>
                                                </td>
                                            @else
                                                ...
                                                <center class="form-group">
                                                    <input class="iradio_flat-green" style="text-align: right"
                                                        oninput="this.nextElementSibling.value = this.value"
                                                        placeholder="60" min="60" max="85" name="{{ $kol }}[{{ $key }}][{{ $k }}]"
                                                        type="range" value="{{ $i+1 }}" @if(($isi[$rekan[$kol]->id][$key][$k] ?? 2) == $i+1) checked @endif
                                                        required>
                                                    <output>60</output>
                                                </center>
                                            ...
                                            @endif
                                                ...
                                                <td style="background-color:{{ $color }}">
                                                    <center class="form-group">
                                                        <input class="iradio_flat-green" style="text-align: right"
                                                            oninput="this.nextElementSibling.value = this.value"
                                                            placeholder="60" min="60" max="85" name="bawahan[{{ $kb }}][{{ $key }}][{{ $k }}]"
                                                            type="range" value="{{ $i+1 }}" @if(($isi[$b->id][$key][$k] ?? 2) == $i+1) checked="checked" @endif
                                                            required>
                                                        <output>60</output>
                                                    </center>
                                                </td>
                                                @elseif (Auth::user()->comment == "Dokter" && Auth::user()->atas == 4)
                                                <td style="background-color:{{ $color }}">
                                                    <center class="form-group">
                                                        <input class="iradio_flat-green" style="text-align: right"
                                                            oninput="this.nextElementSibling.value = this.value"
                                                            placeholder="60" min="60" max="95" name="bawahan[{{ $kb }}][{{ $key }}][{{ $k }}]"
                                                            type="range" value="{{ $i+1 }}" @if(($isi[$b->id][$key][$k] ?? 2) == $i+1) checked="checked" @endif
                                                            required>
                                                        <output>60</output>
                                                    </center>
                                                </td>
                                                @elseif (Auth::user()->atas == 3 || Auth::user()->atas == 4)
                                                <td style="background-color:{{ $color }}">
                                                    <center class="form-group">
                                                        <input class="iradio_flat-green" style="text-align: right"
                                                            oninput="this.nextElementSibling.value = this.value"
                                                ...
                                                @endphp
                                                    ...
                                                    <center class="form-group">
                                                        <input class="iradio_flat-green" style="text-align: right"
                                                        oninput="this.nextElementSibling.value = this.value"
                                                            placeholder="60" min="60" max="95" name="karu[{{ $kr }}][{{ $key }}][{{ $k }}]"
                                                            type="range" value="{{ $i+1 }}" @if(($isi[$r->id][$key][$k] ?? 2) == $i+1) checked="checked" @endif
                                                            required>
                                                            <output>60</output>
                                                    </center>
                                                    </td>
