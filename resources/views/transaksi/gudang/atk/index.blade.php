...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-pencil-square-o"></i> ATK</li>
    </ol>
@endsection
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <div class="box-title" style="margin-top:-5px">
                            <form method="post" action="{{ url('gudang/atk/toexcel') }}">
                                {{ csrf_field() }}
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                    <form method="POST" action="{{ url('gudang/atk') }}" accept-charset="UTF-8" class="" enctype="multipart/form-data">
                            <div class="box-body">
                                {{ csrf_field() }}
                                <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0)" title="Edit atk" class="edit">
                                                ...
                                                <a href="{{ url('gudang/atk/'.$item->id.'/edit') }}" title="Edit atk" class="edit">
                                        ...
                                        {{--   @if($item->id && $item->unit_id == Auth::user()->unit)
                                            <form method="POST" action="{{ url('/transaksi/atk' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                                                <button type="submit" class="btn btn-danger btn-sm" title="Delete atk" ><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                            </form>
                                            @endif--}} 
                                        </td>
                                    </tr>
