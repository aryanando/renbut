...
@section('content-header')
    <h1>
        ...
        <a href="{{ url('/master/pegawai/' . $pegawai->id . '/edit') }}" title="Edit Pegawai"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
        <form method="POST" action="{{ url('master/pegawai' . '/' . $pegawai->id) }}" accept-charset="UTF-8" style="display:inline">
            {{ method_field('DELETE') }}
            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Nama </th><td> {{ $pegawai->nama }} </td></tr><tr><th> Gender </th><td> {{ $pegawai->gender }} </td></tr><tr><th> Unit Id </th><td> {{ $pegawai->unit_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
